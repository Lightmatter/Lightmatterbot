...
robocop is a chat bot built on the [Hubot][hubot] framework. It was initially generated by [generator-hubot][generator-hubot], and configured to be deployed on [Heroku][heroku] to get you up and running as quick as possible.
...
### Running robocop Locally

You can test your hubot by running the following.

You can start robocop locally by running:
...
Then you can interact with robocop by typing `robocop help`.

    robocop> robocop help

    robocop> animate me <query> - The same thing as `image me`, except adds a few
